...
implements fyn_0 {
    ...
    public void a(fyy_0 fyy_02, fyw_0 fyw_02, fvE fvE2) {
        ...
        if (fvE6 != null) {
            object3 = fvE6;
            fyg_04 = (fqh_0)((fvE)object3).getAppearance();
            fyg_04.setElementMap(fyy_03);
            ((fqh_0)fyg_04).setAlign(frs_0.d);
            ((fqD)fyg_04).setPadding(new Insets(0, 4, 0, 4));
            ((fqj)fyg_04).setState("default");
            fvE6.addBasicElement(fyg_04);
            fyg_04.onAttributesInitialized();
            fbn_25 = fqn.checkOut();
            ((fqn)fbn_25).setRenderer(fpm_0.b().g().d("fontDefault16"));
            fbn_25.setElementMap(fyy_03);
            fyg_04.addBasicElement(fbn_25);
        ...
        if (fvE8 != null) {
            ...
            fvE8.addBasicElement(fyb_010);
            fyb_010.onAttributesInitialized();
            fyb_09 = fqv.checkOut();
            fyb_09.setElementMap(fyy_03);
            ((fqv)fyb_09).setHeight(18);
            ((fqv)fyb_09).setPosition(frk_0.i);
            ((fqv)fyb_09).setTexture(this.a.c("txMagnifyingGlass"));
            ((fqv)fyb_09).setWidth(18);
            ((fqv)fyb_09).setX(0);
            ((fqv)fyb_09).setY(0);
            ...
            fvE8.addBasicElement((fyo)object);
            ...
            ((fqv)fyb_04).setX(0);
            ((fqv)fyb_04).setY(40);
            ((fyo)object).addBasicElement(fyb_04);
        ...
        if ((fyb_010 = (fvE3 = fqG2.getParentOfType(fvE.class)).getWidgetByThemeElementName("clearButton", false)) != null) {
            fyb_09 = (fvE)fyb_010;
            ...
            ((fqv)fyb_07).setTexture(this.a.c("txCloseCross"));
            ((fqv)fyb_07).setWidth(18);
            ((fqv)fyb_07).setX(0);
            ((fqv)fyb_07).setY(0);
            ...
            fyb_010.addBasicElement(fyb_05);
            fyb_05.onAttributesInitialized();
            object = fqv.checkOut();
            ((fyb_0)object).setElementMap(fyy_03);
            ((fqv)object).setHeight(18);
            ((fqv)object).setPosition(frk_0.i);
            ((fqv)object).setTexture(this.a.c("txCloseCross"));
            ((fqv)object).setWidth(18);
            ((fqv)object).setX(0);
            ((fqv)object).setY(20);
            fyb_05.addBasicElement((fyo)object);
            ((fyo)object).onAttributesInitialized();
            ((fyb_0)object).onChildrenAdded();
            ...
            fyb_010.addBasicElement(fyb_03);
        ...
        if ((fyb_08 = ((fvE)(fyb_09 = fqG2.getParentOfType(fvE.class))).getWidgetByThemeElementName("list", false)) != null) {
            fyb_07 = (fvE)fyb_08;
            fyb_06 = (fqr)((fvE)fyb_07).getAppearance();
            fyb_06.setElementMap(fyy_03);
            fyb_08.addBasicElement(fyb_06);
            fyb_06.onAttributesInitialized();
            fyb_05 = new fqo_0();
            ((fql_0)fyb_05).onCheckOut();
            fyb_05.setElementMap(fyy_03);
            ((fql_0)fyb_05).setInsets(new Insets(8, 8, 0, 8));
            fyb_06.addBasicElement(fyb_05);
            fyb_05.onAttributesInitialized();
            fyb_05.onChildrenAdded();
            object = "pmbSearchBackground";
            fyb_04 = fby_2.checkOut();
            fyb_04.setElementMap(fyy_03);
            if (fyy_03 != null && object != null) {
                fyy_03.a((String)object, fyb_04);
            }
            ((fby_2)fyb_04).setScaled(true);
            ...
            ((fqv)fyb_03).setTexture(this.a.c("txSearchBackground"));
            ((fqv)fyb_03).setWidth(3);
            ((fqv)fyb_03).setX(0);
            ((fqv)fyb_03).setY(0);
            ...
            fyg_03 = fqv.checkOut();
            fyg_03.setElementMap(fyy_03);
            ((fqv)fyg_03).setHeight(1);
            ((fqv)fyg_03).setPosition(frk_0.h);
            ((fqv)fyg_03).setTexture(this.a.c("txSearchBackground"));
            ((fqv)fyg_03).setWidth(3);
            ((fqv)fyg_03).setX(0);
            ((fqv)fyg_03).setY(16);
            fyb_04.addBasicElement(fyg_03);
            fyg_03.onAttributesInitialized();
            fyg_03.onChildrenAdded();
            fyb_02 = fqv.checkOut();
            fyb_02.setElementMap(fyy_03);
            ((fqv)fyb_02).setHeight(3);
            ((fqv)fyb_02).setPosition(frk_0.m);
            ((fqv)fyb_02).setTexture(this.a.c("txSearchBackground"));
            ((fqv)fyb_02).setWidth(3);
            ((fqv)fyb_02).setX(0);
            ((fqv)fyb_02).setY(29);
            ...
            ((fqv)fyg_02).setTexture(this.a.c("txSearchBackground"));
            ...
            fqv2.setHeight(1);
            fqv2.setPosition(frk_0.i);
            fqv2.setTexture(this.a.c("txSearchBackground"));
            fqv2.setWidth(1);
            fqv2.setX(16);
            fqv2.setY(16);
            fyb_04.addBasicElement(fqv2);
            fqv2.onAttributesInitialized();
            fqv2.onChildrenAdded();
            ...
            fqv8.setTexture(this.a.c("txSearchBackground"));
            fqv8.setWidth(1);
            fqv8.setX(16);
            fqv8.setY(29);
            ...
            fqv9.setTexture(this.a.c("txSearchBackground"));
            fqv9.setWidth(3);
            fqv9.setX(29);
            fqv9.setY(0);
            fyb_04.addBasicElement(fqv9);
            ...
            fqv10.setTexture(this.a.c("txSearchBackground"));
            fqv10.setWidth(3);
            fqv10.setX(29);
            fqv10.setY(16);
            fyb_04.addBasicElement(fqv10);
            ...
            fqv11.setTexture(this.a.c("txSearchBackground"));
            fqv11.setWidth(3);
            fqv11.setX(29);
            fqv11.setY(29);
            fyb_04.addBasicElement(fqv11);
            ...
            fyb_06.addBasicElement(fqg_02);
            fqg_02.onAttributesInitialized();
            fqg_02.onChildrenAdded();
            fvE fvE9 = fyb_06.getParentOfType(fvE.class);
    ...
    public fyo m(fyo fyo2) {
        ...
        fqo_02.onCheckOut();
        fqo_02.setElementMap(fyy_02);
        fqo_02.setInsets(new Insets(0, 2, 8, 0));
