...
implements fyq {
    ...
    public fyo e(fso fso2) {
        ...
        fsM2.setElementMap(fyy_02);
        fsM2.setExpandable(false);
        fsM2.setPrefSize(new fjf_2(40, 0));
        ...
        fiy_15.setElementMap(fyy_02);
        fiy_15.setAttribute("visible");
        fiy_15.setField("effectDescription");
        ...
        fiy_16.setElementMap(fyy_02);
        fiy_16.setAttribute("content");
        fiy_16.setField("effectDescription");
        ...
        fdt_13.a("wakfu.itemDetails:processText(container,stateDetailPopup)");
        fuk_04.setOnClick(fdt_13);
        fdy_1 fdy_12 = new fdy_1();
        fdy_12.a("wakfu.itemDetails:processText(container,stateDetailPopup)");
        fuk_04.setOnMouseEnter(fdy_12);
        fdz_1 fdz_12 = new fdz_1();
        fdz_12.a("xulor:closePopup");
        fuk_04.setOnMouseExit(fdz_12);
