...
implements fyn_0 {
    ...
    public void a(fyy_0 fyy_02, fyw_0 fyw_02, fvE fvE2) {
        ...
        fqv2.setTexture(this.a.c("txWindowBackgroundSmall"));
        fqv2.setWidth(360);
        fqv2.setX(0);
        fqv2.setY(0);
        ...
        fqv3.setTexture(this.a.c("txWindowBackgroundSmall"));
        fqv3.setWidth(0);
        fqv3.setX(0);
        fqv3.setY(0);
        ...
        fqv4.setTexture(this.a.c("txWindowBackgroundSmall"));
        fqv4.setWidth(0);
        fqv4.setX(0);
        fqv4.setY(0);
        ...
        fqv5.setTexture(this.a.c("txWindowBackgroundSmall"));
        fqv5.setWidth(360);
        fqv5.setX(0);
        fqv5.setY(165);
        ...
        fqv6.setTexture(this.a.c("txWindowBackgroundSmall"));
        fqv6.setWidth(0);
        fqv6.setX(0);
        fqv6.setY(165);
        ...
        fqv7.setTexture(this.a.c("txWindowBackgroundSmall"));
        fqv7.setWidth(0);
        fqv7.setX(0);
        fqv7.setY(165);
        ...
        fqv8.setTexture(this.a.c("txWindowBackgroundSmall"));
        fqv8.setWidth(360);
        fqv8.setX(0);
        fqv8.setY(180);
        ...
        fqv9.setTexture(this.a.c("txWindowBackgroundSmall"));
        fqv9.setWidth(0);
        fqv9.setX(0);
        fqv9.setY(180);
        ...
        fqv10.setTexture(this.a.c("txWindowBackgroundSmall"));
        fqv10.setWidth(0);
        fqv10.setX(0);
        fqv10.setY(180);
