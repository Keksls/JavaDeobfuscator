...
public class xq_1
implements gs_0 {
    public final ArrayList<xr_2> a = new ArrayList(0);
    ...
    public boolean a(ByteBuffer byteBuffer) {
        ...
        for (int k = 0; k < this.a.size(); ++k) {
            xr_2 xr_22 = this.a.get(k);
            boolean bl = xr_22.a(byteBuffer);
            if (bl) continue;
            return false;
        }
        return true;
    ...
    public final void a(StringBuilder stringBuilder, String string) {
        ...
        if (this.a.isEmpty()) {
            ...
            for (int k = 0; k < this.a.size(); ++k) {
                xr_2 xr_22 = this.a.get(k);
                xr_22.a(stringBuilder, string + k + "/ ");
            }
        }
    }
}
