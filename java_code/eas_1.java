...
implements fyn_0 {
    ...
    public void a(fyy_0 fyy_02, fyw_0 fyw_02, fvE fvE2) {
        ...
        fqj fqj3 = fvE6.getAppearance();
        fqj3.setElementMap(fyy_03);
        fqj3.onAttributesInitialized();
        fvE fvE7 = fqj3.getParentOfType(fvE.class);
        fvE fvE8 = fvE7.getWidgetByThemeElementName("verticalIncreaseButton", false);
        if (fvE8 != null) {
            fyb_011 = new fqo_0();
            ((fql_0)fyb_011).onCheckOut();
            fyb_011.setElementMap(fyy_03);
            ((fql_0)fyb_011).setInsets(new Insets(1, 1, 1, 1));
            fvE8.addBasicElement(fyb_011);
        ...
        if ((fvE3 = ((fvE)(fyb_011 = fqj3.getParentOfType(fvE.class))).getWidgetByThemeElementName("verticalDecreaseButton", false)) != null) {
            fyb_010 = new fqo_0();
        ...
        if ((fyb_09 = ((fvE)(fyb_010 = fqj3.getParentOfType(fvE.class))).getWidgetByThemeElementName("verticalSlider", false)) != null) {
            fyb_08 = fyb_09;
            ...
            if (fyb_06 != null) {
                ...
                fyb_04.onChildrenAdded();
                fvE fvE9 = (fvE)fyb_06;
                fqd_0 fqd_02 = (fqd_0)fvE9.getAppearance();
