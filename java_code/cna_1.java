...
implements fyq {
    ...
    public fyo a(fya_0 fya_02, fyy_0 fyy_02) {
        ...
        string2 = string2.replace("%emoticons%", fpm_0.b().c("emoticons"));
        fsM2.c(string2);
        ...
        fid_14.setSize(new fjf_2(420, 20));
        ...
        fuh_02.b(string4);
        fuh_02.setMaxWidth(300);
        fuh_02.setMinWidth(300);
        ...
        fiy_12.setName("emotesInventory");
        ...
        fid_15.setSize(new fjf_2(10, 100.0f));
        ...
        fqo_04.setInsets(new Insets(0, 18, 20, 4));
        ...
        fso15.setPrefSize(new fjf_2(415, 0));
        ...
        fqm_07.setInsets(new Insets(5, 13, 5, 13));
        ...
        fsk_02.setDisplaySize(new fjf_2(390, 29));
        ...
        string5 = string5.replace("%emote.emotes%", fpm_0.b().c("emote.emotes"));
        fuk_02.c(string5);
        ...
        fiy_13.setField("emotes");
        fiy_13.setName("emotesInventory");
        ...
        fdi_12.a("wakfu.emotesInventory:onClick");
        faf_22.setOnItemClick(fdi_12);
        fdl_2 fdl_22 = new fdl_2();
        fdl_22.a("wakfu.emotesInventory:overSmiley");
        ...
        if (fyy_03 != null && string6 != null) {
            fyy_03.a(string6, fso20);
        }
        fso20.setNonBlocking(false);
        fde_2 fde_22 = new fde_2();
        fde_22.a("popup(emoteDescPopup,emotionContainer)");
        fso20.setOnPopupDisplay(fde_22);
        fdf_2 fdf_22 = new fdf_2();
        fdf_22.a("closePopup");
        fso20.setOnPopupHide(fdf_22);
        fso20.setPrefSize(new fjf_2(38, 0));
    ...
    public fyo a(fsv_0 fsv_02) {
        ...
        fso2.setStyle("fighterControlsNotAllowed");
    ...
    public fyo b(fso fso2) {
        ...
        string = string.replace("%emote.targetEmotes%", fpm_0.b().c("emote.targetEmotes"));
        fuk_02.c(string);
    ...
    public fyo c(fso fso2) {
        ...
        fiy_12.setField("emotesWithTarget");
        fiy_12.setName("emotesInventory");
    ...
    public fyo d(fso fso2) {
        ...
        string = string.replace("%emote.smileys%", fpm_0.b().c("emote.smileys"));
        fuk_02.c(string);
        fso3.addBasicElement(fuk_02);
        fuk_02.onAttributesInitialized();
        fid_1 fid_13 = new fid_1();
    ...
    public fyo e(fso fso2) {
        ...
        fdl_23.a("wakfu.emotesInventory:overSmiley");
        ...
        far_24.addBasicElement(fav_16);
        fav_16.onAttributesInitialized();
        fac_1 fac_12 = new fac_1();
        fac_12.onCheckOut();
        fac_12.setElementMap(fyy_02);
        fav_16.addBasicElement(fac_12);
        fac_12.onAttributesInitialized();
        fac_12.onChildrenAdded();
