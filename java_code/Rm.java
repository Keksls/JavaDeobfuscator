...
public class Rm
extends rg_0 {
    private static final Logger a = Logger.getLogger(Rm.class);
    private String b;
    ...
    protected boolean a(String string) {
        try {
            ...
            if (stringArray == null || stringArray.length != 1) {
                a.error((Object)("Impossible d'initialiser un " + this.getClass().getName() + ", pas assez de param\u00e8tres (il en faut 1 : Animstatix) : " + string));
                return false;
            }
