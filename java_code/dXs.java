...
implements fyn_0 {
    ...
    public void a(fyy_0 fyy_02, fyw_0 fyw_02, fvE fvE2) {
        ...
        fvE fvE6 = fvE5.getWidgetByThemeElementName("horizontalScrollbar", false);
        if (fvE6 != null) {
            fyg_0 fyg_02;
            Object object;
            fyg_0 fyg_03;
            ...
            fvE fvE7;
            fvE fvE8 = fvE6;
            fqj fqj3 = fvE8.getAppearance();
            fqj3.setElementMap(fyy_03);
            fvE6.addBasicElement(fqj3);
            fqj3.onAttributesInitialized();
            fvE fvE9 = fqj3.getParentOfType(fvE.class);
            fvE fvE10 = fvE9.getWidgetByThemeElementName("horizontalDecreaseButton", false);
            if (fvE10 != null) {
                fvE7 = fvE10;
                fyb_04 = (fqd_0)fvE7.getAppearance();
                fyb_04.setElementMap(fyy_03);
                ((fqj)fyb_04).setState("default");
                fvE10.addBasicElement(fyb_04);
            ...
            if ((fyb_04 = (fvE7 = fqj3.getParentOfType(fvE.class)).getWidgetByThemeElementName("horizontalIncreaseButton", false)) != null) {
                object15 = (fvE)fyb_04;
            ...
            if ((fyb_03 = ((fvE)(object15 = fqj3.getParentOfType(fvE.class))).getWidgetByThemeElementName("horizontalSlider", false)) != null) {
                object14 = (fvE)fyb_03;
    ...
    public fyo e(fyo fyo2) {
        ...
        if (fvE3 != null) {
            ...
            if (fvE7 != null) {
                fvE4 = fvE7;
                fyb_05 = (fqd_0)fvE4.getAppearance();
                fyb_05.setElementMap(fyy_02);
                ...
                if (fyy_02 != null && object15 != null) {
                    fyy_02.a((String)object15, fyb_04);
                }
                ...
                if (fyy_02 != null && object13 != null) {
                    fyy_02.a((String)object13, fyb_03);
                }
                ((fqv)fyb_03).setHeight(16);
                ((fqv)fyb_03).setPosition(frk_0.i);
                ...
                fyg_012.setElementMap(fyy_02);
                ((fqj)fyg_012).setState("pressed");
                fvE7.addBasicElement(fyg_012);
                fyg_012.onAttributesInitialized();
                object11 = "pmSmallDownSideArrow2Pressed";
                fyg_011 = fqv.checkOut();
                fyg_011.setElementMap(fyy_02);
                if (fyy_02 != null && object11 != null) {
                    fyy_02.a((String)object11, fyg_011);
                }
                ((fqv)fyg_011).setHeight(16);
                ((fqv)fyg_011).setPosition(frk_0.i);
                ((fqv)fyg_011).setTexture(this.a.c("themePressed"));
                ...
                fyg_010.setElementMap(fyy_02);
                ((fqj)fyg_010).setState("disabled");
                fvE7.addBasicElement(fyg_010);
                fyg_010.onAttributesInitialized();
                object9 = "pmSmallDownSideArrow2Disabled";
                fyg_09 = fqv.checkOut();
                fyg_09.setElementMap(fyy_02);
                if (fyy_02 != null && object9 != null) {
                    fyy_02.a((String)object9, fyg_09);
                }
                ((fqv)fyg_09).setHeight(16);
                ((fqv)fyg_09).setPosition(frk_0.i);
                ((fqv)fyg_09).setTexture(this.a.c("themeDisabled"));
                ...
                if (fyy_02 != null && object5 != null) {
                    fyy_02.a((String)object5, fyg_06);
                }
                ((fqv)fyg_06).setHeight(16);
                ((fqv)fyg_06).setPosition(frk_0.i);
                ((fqv)fyg_06).setTexture(this.a.c("themeOverSelected"));
                ...
                if (fyy_02 != null && object3 != null) {
                    fyy_02.a((String)object3, fyg_04);
                }
                ((fqv)fyg_04).setHeight(16);
                ((fqv)fyg_04).setPosition(frk_0.i);
                ((fqv)fyg_04).setTexture(this.a.c("themePressedSelected"));
            ...
            if ((fyb_05 = (fvE4 = fqj2.getParentOfType(fvE.class)).getWidgetByThemeElementName("verticalIncreaseButton", false)) != null) {
                object15 = (fvE)fyb_05;
                ...
                fyg_013 = fqv.checkOut();
                fyg_013.setElementMap(fyy_02);
                if (fyy_02 != null && object14 != null) {
                    fyy_02.a((String)object14, fyg_013);
                }
                ((fqv)fyg_013).setHeight(16);
                ((fqv)fyg_013).setPosition(frk_0.i);
                ...
                fyg_012 = fqv.checkOut();
                fyg_012.setElementMap(fyy_02);
                if (fyy_02 != null && object12 != null) {
                    fyy_02.a((String)object12, fyg_012);
                }
                ((fqv)fyg_012).setHeight(16);
                ((fqv)fyg_012).setPosition(frk_0.i);
                ...
                fyg_010 = fqv.checkOut();
                fyg_010.setElementMap(fyy_02);
                if (fyy_02 != null && object10 != null) {
                    fyy_02.a((String)object10, fyg_010);
                }
                ((fqv)fyg_010).setHeight(16);
                ((fqv)fyg_010).setPosition(frk_0.i);
                ...
                if (fyy_02 != null && object8 != null) {
                    fyy_02.a((String)object8, fyg_08);
                }
                ((fqv)fyg_08).setHeight(16);
                ((fqv)fyg_08).setPosition(frk_0.i);
                ...
                if (fyy_02 != null && object4 != null) {
                    fyy_02.a((String)object4, fyg_05);
                }
                ((fqv)fyg_05).setHeight(16);
                ((fqv)fyg_05).setPosition(frk_0.i);
                ((fqv)fyg_05).setTexture(this.a.c("themeOverSelected"));
                ...
                if (fyy_02 != null && object2 != null) {
                    fyy_02.a((String)object2, fyg_03);
                }
                ((fqv)fyg_03).setHeight(16);
                ((fqv)fyg_03).setPosition(frk_0.i);
                ((fqv)fyg_03).setTexture(this.a.c("themePressedSelected"));
            ...
            if ((fyb_04 = ((fvE)(object15 = fqj2.getParentOfType(fvE.class))).getWidgetByThemeElementName("verticalSlider", false)) != null) {
                ...
                if (fyb_03 != null) {
                    ...
                    object11 = new fbc_1();
                    ((fbc_1)object11).onCheckOut();
                    ((fyb_0)object11).setElementMap(fyy_02);
                    ...
                    fyg_011.onChildrenAdded();
                    object10 = fqv.checkOut();
                    ((fyb_0)object10).setElementMap(fyy_02);
                    ((fqv)object10).setHeight(28);
                    ...
                    fyg_010.onChildrenAdded();
                    object9 = fqv.checkOut();
                    ((fyb_0)object9).setElementMap(fyy_02);
                    ((fqv)object9).setHeight(1);
                    ...
                    fyg_09.onChildrenAdded();
                    object8 = fqv.checkOut();
                    ((fyb_0)object8).setElementMap(fyy_02);
                    ((fqv)object8).setHeight(28);
                    ...
                    fyg_08.onChildrenAdded();
                    object7 = fqv.checkOut();
                    ((fyb_0)object7).setElementMap(fyy_02);
                    ((fqv)object7).setHeight(1);
                    ...
                    ((fyb_0)object6).setElementMap(fyy_02);
                    ...
                    ((fyb_0)object5).setElementMap(fyy_02);
