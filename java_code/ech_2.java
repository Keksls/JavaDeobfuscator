...
implements fyn_0 {
    ...
    public void a(fyy_0 fyy_02, fyw_0 fyw_02, fvE fvE2) {
        ...
        if (fvE6 != null) {
            object3 = fvE6;
            fyg_06 = (fqh_0)((fvE)object3).getAppearance();
            fyg_06.setElementMap(fyy_03);
            ((fqh_0)fyg_06).setAlign(frs_0.d);
            ((fqD)fyg_06).setPadding(new Insets(0, 4, 0, 4));
            ((fqj)fyg_06).setState("default");
            fvE6.addBasicElement(fyg_06);
            fyg_06.onAttributesInitialized();
            fbn_26 = fqn.checkOut();
            ((fqn)fbn_26).setRenderer(fpm_0.b().g().d("fontDefault16"));
            fbn_26.setElementMap(fyy_03);
            fyg_06.addBasicElement(fbn_26);
            fbn_26.onAttributesInitialized();
            fbn_26.onChildrenAdded();
            object2 = fqg_0.checkOut();
            ((fyb_0)object2).setElementMap(fyy_03);
            ((fqg_0)object2).setColor(new fyr_0("mainTextLightColor"));
            fyg_06.addBasicElement((fyo)object2);
            ...
            fyg_06.addBasicElement(fbm_22);
            fbm_22.onAttributesInitialized();
            fbm_22.onChildrenAdded();
            fbn_25 = fqg_0.checkOut();
            fbn_25.setElementMap(fyy_03);
            ((fqg_0)fbn_25).setColor(new fyr_0("mainTextTitleColor", 0.5f));
            ((fqg_0)fbn_25).setName("ghostText");
            fyg_06.addBasicElement(fbn_25);
            fbn_25.onAttributesInitialized();
            fbn_25.onChildrenAdded();
            fbn_24 = fqg_0.checkOut();
            fbn_24.setElementMap(fyy_03);
            ((fqg_0)fbn_24).setColor(new fyr_0("mainTextTitleColor"));
            ((fqg_0)fbn_24).setName("selection");
            fyg_06.addBasicElement(fbn_24);
            ...
            ((fqg_0)fbn_23).setName("cursor");
            fyg_06.addBasicElement(fbn_23);
            fbn_23.onAttributesInitialized();
            fbn_23.onChildrenAdded();
            fyg_06.onChildrenAdded();
            fyb_010 = fvE6;
            fyg_05 = (fqh_0)((fvE)fyb_010).getAppearance();
            fyg_05.setElementMap(fyy_03);
            ((fqh_0)fyg_05).setAlign(frs_0.e);
            fvE6.addBasicElement(fyg_05);
            fyg_05.onAttributesInitialized();
            fbn_22 = fqn.checkOut();
            ((fqn)fbn_22).setRenderer(fpm_0.b().g().d("fontDefault14"));
        ...
        fyg_06 = fby_2.checkOut();
        fyg_06.setElementMap(fyy_03);
        if (fyy_03 != null && object3 != null) {
            fyy_03.a((String)object3, fyg_06);
        }
        ((fby_2)fyg_06).setScaled(true);
        fqG2.addBasicElement(fyg_06);
        fyg_06.onAttributesInitialized();
        fbn_26 = fqv.checkOut();
        fbn_26.setElementMap(fyy_03);
        ((fqv)fbn_26).setHeight(1);
        ((fqv)fbn_26).setPosition(frk_0.i);
        ((fqv)fbn_26).setTexture(this.a.c("txTextEditor1"));
        ((fqv)fbn_26).setWidth(1);
        ((fqv)fbn_26).setX(16);
        ((fqv)fbn_26).setY(16);
        fyg_06.addBasicElement(fbn_26);
        fbn_26.onAttributesInitialized();
        ...
        fbn_25 = fqv.checkOut();
        fbn_25.setElementMap(fyy_03);
        ((fqv)fbn_25).setHeight(4);
        ((fqv)fbn_25).setPosition(frk_0.a);
        ((fqv)fbn_25).setTexture(this.a.c("txTextEditor1"));
        ((fqv)fbn_25).setWidth(4);
        ((fqv)fbn_25).setX(0);
        ((fqv)fbn_25).setY(0);
        fbm_22.addBasicElement(fbn_25);
        fbn_25.onAttributesInitialized();
        fbn_25.onChildrenAdded();
        fbn_24 = fqv.checkOut();
        fbn_24.setElementMap(fyy_03);
        ((fqv)fbn_24).setHeight(1);
        ((fqv)fbn_24).setPosition(frk_0.h);
        ...
        fbn_23 = fqv.checkOut();
        fbn_23.setElementMap(fyy_03);
        ((fqv)fbn_23).setHeight(4);
        ((fqv)fbn_23).setPosition(frk_0.m);
        ...
        ((fqv)fyb_010).setHeight(4);
        ((fqv)fyb_010).setPosition(frk_0.c);
        ((fqv)fyb_010).setTexture(this.a.c("txTextEditor1"));
        ((fqv)fyb_010).setWidth(1);
        ((fqv)fyb_010).setX(16);
        ((fqv)fyb_010).setY(0);
        fbm_22.addBasicElement(fyb_010);
        fyb_010.onAttributesInitialized();
        fyb_010.onChildrenAdded();
        fyg_05 = fqv.checkOut();
        fyg_05.setElementMap(fyy_03);
        ((fqv)fyg_05).setHeight(4);
        ((fqv)fyg_05).setPosition(frk_0.o);
        ((fqv)fyg_05).setTexture(this.a.c("txTextEditor1"));
        ((fqv)fyg_05).setWidth(1);
        ((fqv)fyg_05).setX(16);
        ((fqv)fyg_05).setY(28);
        fbm_22.addBasicElement(fyg_05);
        fyg_05.onAttributesInitialized();
        fyg_05.onChildrenAdded();
        fbn_22 = fqv.checkOut();
        fbn_22.setElementMap(fyy_03);
        ((fqv)fbn_22).setHeight(4);
        ((fqv)fbn_22).setPosition(frk_0.e);
        ...
        if ((fyb_07 = ((fvE)(fyb_08 = fqG2.getParentOfType(fvE.class))).getWidgetByThemeElementName("list", false)) != null) {
            ...
            if (fvE10 != null) {
                ...
                if (fvE13 != null) {
                    ...
                    fqv8.setTexture(this.a.c("txScrollbarButton"));
                    fqv8.setWidth(8);
                    fqv8.setX(0);
                    fqv8.setY(0);
                    fqd_02.addBasicElement(fqv8);
