...
implements fyq {
    ...
    public fyo a(fya_0 fya_02, fyy_0 fyy_02) {
        ...
        String string = "%characterCreation.nation%";
        string = string.replace("%characterCreation.nation%", fpm_0.b().c("characterCreation.nation"));
        fsM2.c(string);
        ...
        fid_13.setSize(new fjf_2(696, 522));
        ...
        fsQ2.setCellSize(new fjf_2(348, 261));
        ...
        fdi_12.a("wakfu.nationChoice:selectNation");
        faf_22.setOnItemClick(fdi_12);
        fdj_1 fdj_12 = new fdj_1();
        fdj_12.a("wakfu.nationChoice:selectDoubleClickNation");
        ...
        String string4 = "popupReferenceContainer";
        fso fso12 = fso.checkOut();
        fso12.setElementMap(fyy_03);
        if (fyy_03 != null && string4 != null) {
            fyy_03.a(string4, fso12);
        }
        fso12.setNonBlocking(false);
        fdy_1 fdy_12 = new fdy_1();
        fdy_12.a("wakfu.nationChoice:overNation(nation);popup(nationPopup,popupReferenceContainer)");
        fso12.setOnMouseEnter(fdy_12);
        fdz_1 fdz_12 = new fdz_1();
        fdz_12.a("wakfu.nationChoice:outNation(nation);closePopup");
        ...
        fid_16.setSize(new fjf_2(40.0f, 40.0f));
        ...
        fdt_12.a("wakfu.nationChoice:backToArchipelagoChoice");
        ...
        fso14.setPrefSize(new fjf_2(112, 50));
        ...
        fiy_15.setField("flagIconUrl");
        fiy_15.setName("overNation");
        ...
        fso17.setPrefSize(new fjf_2(0, 7));
        fso17.setStyle("lineSeparator");
    ...
    public fyo d(fso fso2) {
        ...
        String string = "%doubleClickToValid%";
        string = string.replace("%doubleClickToValid%", fpm_0.b().c("doubleClickToValid"));
        fsM2.c(string);
