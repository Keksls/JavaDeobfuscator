...
implements fyq {
    ...
    public fyo a(fya_0 fya_02, fyy_0 fyy_02) {
        ...
        String string = "splitTemporaryInventoryContainer";
        ...
        fdb_12.a("wakfu.temporaryInventory:decreaseSplitCount");
        ...
        fdo_12.a("wakfu.temporaryInventory:keyType(quantityTextEditor)");
        ...
        fdb_13.a("wakfu.temporaryInventory:increaseSplitCount");
        fru_03.setOnMousePress(fdb_13);
        fru_03.setStyle("yellowRightArrow");
        fih_23.addBasicElement(fru_03);
