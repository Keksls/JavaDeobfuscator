...
implements fkd_1 {
    ...
    final /* synthetic */ cVS b;

    cVT(cVS cVS2, fvk_0 fvk_02) {
        this.b = cVS2;
        this.a = fvk_02;
    }
    ...
    @Override
    public void a() {
        fyy_0 fyy_02 = fpm_0.b().h().d("artisansBookDialog");
        if (fyy_02 == null) {
            return;
        }
        fvk_0 fvk_02 = (fvk_0)fyy_02.a("craftTableWindow");
