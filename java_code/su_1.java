    ...
    public void a(ByteBuffer byteBuffer) {
        try {
            ...
            if (bl) {
                ...
                this.a("Erreur lors de la s\u00e9rialisation de CharacterSerializedRunningEffectsForSave");
            }
        }
    ...
    public void a(ByteBuffer byteBuffer, int n) {
        try {
            ...
            if (bl) {
                ...
                this.a("Erreur lors de la d\u00e9s\u00e9rialisation de CharacterSerializedRunningEffectsForSave");
            }
        }
        catch (Exception exception) {
