...
implements fyq {
    ...
    public fyo a(fya_0 fya_02, fyy_0 fyy_02) {
        ...
        string2 = string2.replace("%protector.kamas.transfer%", fpm_0.b().c("protector.kamas.transfer"));
        fuk_02.c(string2);
        ...
        string4 = string4.replace("%protector.kamasToTransfer%", fpm_0.b().c("protector.kamasToTransfer"));
        fsM2.c(string4);
        ...
        fdo_12.a("wakfu.protectorManagement:validateBudgetTransfer(confirmButton)");
        ...
        fsk2.setPrefSize(new fjf_2(250, 0));
    ...
    public fyo b(fso fso2) {
        ...
        if (fyy_02 != null && string != null) {
            fyy_02.a(string, fru_04);
        }
        fru_04.setEnabled(true);
        fru_04.setExpandable(false);
        fdt_1 fdt_13 = new fdt_1();
        fdt_13.a("wakfu.protectorManagement:transferBudget(amountTextEditor,territoryCombo)");
