...
implements fyq {
    ...
    public fyo a(fya_0 fya_02, fyy_0 fyy_02) {
        ...
        fso12.setPrefSize(new fjf_2(465, 500));
        ...
        fqm_05.setInsets(new Insets(30, 0, 35, 0));
        ...
        fqm_07.setInsets(new Insets(0, 10, 0, 15));
        ...
        fso18.setPrefSize(new fjf_2(300, 200));
        ...
        fso20.setPrefSize(new fjf_2(0, 70));
        fso20.setStyle("AchievementUnlockedSplashScaled");
        ...
        fid_110.setSize(new fjf_2(200, 200));
        ...
        fiy_14.setName("selectedBuilding");
        ...
        fqm_08.setInsets(new Insets(5, 15, 5, 15));
        ...
        fqm_09.setInsets(new Insets(10, 0, 5, 0));
        ...
        fsk_05.setPrefSize(new fjf_2(423, 29));
        ...
        string2 = string2.replace("%buildingDate%", fpm_0.b().c("buildingDate"));
        fsM4.c(string2);
    ...
    public fyo a(fso fso2) {
        ...
        fiy_12.setAttribute("text");
        fiy_12.setField("constructionDate");
        fiy_12.setName("selectedBuilding");
    ...
    public fyo b(fso fso2) {
        ...
        string = string.replace("%havenWorld.buildingRemainingTime%", fpm_0.b().c("havenWorld.buildingRemainingTime"));
        fsM2.c(string);
    ...
    public fyo d(fso fso2) {
        ...
        string = string.replace("%buildingEffects%", fpm_0.b().c("buildingEffects"));
        fsM2.c(string);
        fso3.addBasicElement(fsM2);
        fsM2.onAttributesInitialized();
        fid_1 fid_13 = new fid_1();
    ...
    public fyo e(fso fso2) {
        ...
        fbf_12.setColor(new azf_2(0.35f, 0.35f, 0.42f, 0.3f));
        ...
        fbh_12.setColor(new azf_2(0.35f, 0.35f, 0.42f, 0.8f));
    ...
    public fyo f(fso fso2) {
        ...
        fdt_12.a("wakfu.havenWorld:evolveBuilding");
        ...
        string2 = string2.replace("%havenWorld.buildingEvolve%", fpm_0.b().c("havenWorld.buildingEvolve"));
        fuk_02.c(string2);
        ...
        fdt_13.a("wakfu.buildingPanel:deleteBuilding");
        ...
        string4 = string4.replace("%havenWorld.destroyElement%", fpm_0.b().c("havenWorld.destroyElement"));
        fuk_04.c(string4);
        ...
        fsk_04.setNonBlocking(true);
        fsk_04.setStyle("HavenWorldDelete");
    ...
    public fyo g(fso fso2) {
        ...
        fid_12.setSize(new fjf_2(465, 100.0f));
        fid_12.setXOffset(-9);
        fid_12.setYOffset(1);
        fso3.addBasicElement(fid_12);
        fid_12.onAttributesInitialized();
    ...
    public fyo h(fso fso2) {
        ...
        string = string.replace("%havenWorld.buildingFrontChange%", fpm_0.b().c("havenWorld.buildingFrontChange"));
        fuk_02.c(string);
        fso2.addBasicElement(fuk_02);
        fuk_02.onAttributesInitialized();
        fuk_0 fuk_03 = fuk_02;
    ...
    public fyo i(fso fso2) {
        ...
        fsk_02.setElementMap(fyy_02);
        fsk_02.setNonBlocking(true);
        fsk_02.setStyle("FrontManualDecorator");
        fso3.addBasicElement(fsk_02);
        fsk_02.onAttributesInitialized();
        fid_1 fid_12 = new fid_1();
        fid_12.onCheckOut();
        ...
        fso4.setPrefSize(new fjf_2(55, 55));
        ...
        fid_14.setElementMap(fyy_02);
        fid_14.setAlign(frk_0.i);
        fid_14.setSize(new fjf_2(55, 55));
        ...
        fdb_22.a("wakfu.buildingPanel:removeFrontManual");
        fsv_02.setOnDrag(fdb_22);
        fde_1 fde_12 = new fde_1();
        fde_12.a("wakfu.buildingPanel:dropFrontManual");
        fsv_02.setOnDrop(fde_12);
        fde_2 fde_22 = new fde_2();
        fde_22.a("popup(frontPopup)");
        ...
        string3 = string3.replace("%frontManual%", fpm_0.b().c("frontManual"));
        fsM2.c(string3);
        ...
        string4 = string4.replace("%desc.frontManual%", fpm_0.b().c("desc.frontManual"));
        fuk_02.c(string4);
        fso5.addBasicElement(fuk_02);
        fuk_02.onAttributesInitialized();
        fuk_0 fuk_03 = fuk_02;
