        ...
        if ((fyb_06 = (fvE3 = fqi2.getParentOfType(fvE.class)).getWidgetByThemeElementName("list", false)) != null) {
            ...
            if (fvE9 != null) {
                ...
                if (fvE13 != null) {
                    ...
                    fyb_011 = fvE13;
                    fyg_05 = (fqd_0)((fvE)fyb_011).getAppearance();
                    fyg_05.setElementMap(fyy_03);
                    ((fqj)fyg_05).setState("mouseHover");
                ...
                if ((fvE10 = ((fvE)(fyb_014 = fqj2.getParentOfType(fvE.class))).getWidgetByThemeElementName("verticalDecreaseButton", false)) != null) {
                    ...
                    ((fqv)fyg_05).setTexture(this.a.c("themeDefault"));
                    ((fqv)fyg_05).setWidth(10);
                    ((fqv)fyg_05).setX(119);
                    ((fqv)fyg_05).setY(3);
                    fyb_011.addBasicElement(fyg_05);
                    fyg_05.onAttributesInitialized();
                    fyg_05.onChildrenAdded();
                    ...
                    ((fqv)fyg_04).setTexture(this.a.c("themeOver"));
                ...
                if ((fyb_012 = ((fvE)(fyb_013 = fqj2.getParentOfType(fvE.class))).getWidgetByThemeElementName("verticalSlider", false)) != null) {
                    fyb_011 = fyb_012;
                    fyg_05 = ((fvE)fyb_011).getAppearance();
                    fyg_05.setElementMap(fyy_03);
                    fyb_012.addBasicElement(fyg_05);
                    fyg_05.onAttributesInitialized();
                    fyb_010 = fyg_05.getParentOfType(fvE.class);
