...
implements fyq {
    ...
    public fyo b(fso fso2) {
        ...
        fsk_02.setExpandable(false);
        fsk_02.setNonBlocking(true);
        fsk_02.setStyle("stateBarContainerTop");
        ...
        fsk_03.setStyle("stateBarContainerCenterVertical");
        ...
        fsk_04.setStyle("stateBarContainerBottom");
    ...
    public fyo c(fso fso2) {
        ...
        fqm_0 fqm_02 = fqm_0.checkOut();
        fqm_02.setElementMap(fyy_02);
        fqm_02.setInsets(new Insets(5, 9, 5, 0));
