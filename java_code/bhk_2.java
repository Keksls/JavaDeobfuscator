...
implements bhr_2 {
    ...
    public bhk_2(int n, aqd_1 aqd_12, BitSet bitSet, BitSet bitSet2, int n2, int n3, int n4, float[] fArray, String string, String string2, String string3, String string4, float[] fArray2, boolean bl, boolean bl2, int n5) {
    ...
    public bhk_2 a(elb_0 elb_02) {
        bhk_2 bhk_22 = (bhk_2)super.b(elb_02);
        bhk_22.x = this.x;
        bhk_22.y.a(this.y);
        bhk_22.ar();
        return bhk_22;
