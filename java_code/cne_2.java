...
implements fyq {
    ...
    public fyo a(fya_0 fya_02, fyy_0 fyy_02) {
        ...
        string = string.replace("%eventsCalendar.create.title%", fpm_0.b().c("eventsCalendar.create.title"));
        fsM2.c(string);
        ...
        fso10.setPrefSize(new fjf_2(350, 0));
        ...
        fiy_14.setAttribute("maxChars");
        fiy_14.setName("calendar.event.desc.maxChars");
        ...
        fiy_16.setField("endDateDesc");
        fiy_16.setName("calendar.event.editable");
        fuk_03.addBasicElement(fiy_16);
    ...
    public fyo e(fso fso2) {
        ...
        string2 = string2.replace("%eventsCalendar.eventMaxRegistered%", fpm_0.b().c("eventsCalendar.eventMaxRegistered"));
        fsM2.c(string2);
        ...
        fiy_13.setElementMap(fyy_02);
        fiy_13.setAttribute("text");
        fiy_13.setField("maxRegistrations");
        fiy_13.setName("calendar.event.editable");
        ...
        fiy_14.setName("calendar.event.editable.isOwner");
        ...
        string5 = string5.replace("%eventsCalendar.eventMaxParticipants%", fpm_0.b().c("eventsCalendar.eventMaxParticipants"));
        fsM4.c(string5);
        ...
        fiy_16.setAttribute("text");
        fiy_16.setField("maxParticipants");
        fiy_16.setName("calendar.event.editable");
        fug_04.addBasicElement(fiy_16);
        fiy_16.onAttributesInitialized();
        fiy_16.onChildrenAdded();
    ...
    public fyo g(fso fso2) {
        ...
        fru_02.setElementMap(fyy_02);
        fdt_1 fdt_12 = new fdt_1();
        fdt_12.a("wakfu.eventsCalendar:createEvent(title,description,maxParticipants,maxRegistrations)");
        fru_02.setOnClick(fdt_12);
        fru_02.setStyle("flat");
        String string = "%eventsCalendar.create.action%";
        string = string.replace("%eventsCalendar.create.action%", fpm_0.b().c("eventsCalendar.create.action"));
    ...
    public fyo b(fvk_0 fvk_02) {
        ...
        fdt_1 fdt_12 = new fdt_1();
        fdt_12.a("wakfu.eventsCalendar:closeCreateEventDialog");
        fru_02.setOnClick(fdt_12);
