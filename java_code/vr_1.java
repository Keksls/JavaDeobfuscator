...
public class vr_1
implements gs_0 {
    public final ArrayList<vs_2> a = new ArrayList(0);
    ...
    public boolean a(ByteBuffer byteBuffer) {
        ...
        for (int k = 0; k < this.a.size(); ++k) {
            vs_2 vs_22 = this.a.get(k);
            boolean bl = vs_22.a(byteBuffer);
            if (bl) continue;
            return false;
        }
        return true;
    ...
    public final void a(StringBuilder stringBuilder, String string) {
        ...
        if (this.a.isEmpty()) {
            ...
            for (int k = 0; k < this.a.size(); ++k) {
                vs_2 vs_22 = this.a.get(k);
                vs_22.a(stringBuilder, string + k + "/ ");
            }
        }
    }
}
