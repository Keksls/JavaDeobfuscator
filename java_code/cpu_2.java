...
implements fyq {
    ...
    public fyo a(fya_0 fya_02, fyy_0 fyy_02) {
        ...
        frO2.setOffsetX(215.0f);
        frO2.setOffsetY(-5.0f);
        ...
        frO3.setOffsetX(-215.0f);
        frO3.setOffsetY(-5.0f);
        ...
        fsk_03.setKeepAspectRatio(false);
        fsk_03.setNonBlocking(true);
        fsk_03.setScaled(true);
        fsk_03.setStyle("ZoneNameCenter");
        ...
        if (fyy_03 != null && string7 != null) {
            fyy_03.a(string7, fsk_04);
        }
        fsk_04.setExpandable(false);
        fsk_04.setNonBlocking(true);
        fsk_04.setStyle("ZoneNameRight");
        ...
        fqm_03.setInsets(new Insets(0, 250, 30, 250));
