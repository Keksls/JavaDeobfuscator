...
extends esi_0 {
    ...
    public euv(ArrayList<aot_2> arrayList) {
    ...
    public long a(Object object, Object object2, Object object3, Object object4) {
        ...
        Integer n = optional.map(arg_0 -> erQ.f.apply(arg_0)).map(arg_0 -> erQ.a.apply(arg_0)).map(arg_0 -> erQ.c.apply(arg_0)).map(tIntObjectHashMap -> new euw(l).a((TIntObjectHashMap<aeo_2>)tIntObjectHashMap)).map(arg_0 -> erQ.d.apply(arg_0)).orElse(0);
