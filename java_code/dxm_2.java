...
implements fyn_0 {
    ...
    public void a(fyy_0 fyy_02, fyw_0 fyw_02, fvE fvE2) {
        ...
        fyg_02 = fby_2.checkOut();
        fyg_02.setElementMap(fyy_03);
        if (fyy_03 != null && object2 != null) {
            fyy_03.a((String)object2, fyg_02);
        }
        ((fby_2)fyg_02).setScaled(true);
        fqj2.addBasicElement(fyg_02);
        fyg_02.onAttributesInitialized();
        object = fqv.checkOut();
        ((fyb_0)object).setElementMap(fyy_03);
        ((fqv)object).setHeight(4);
        ((fqv)object).setPosition(frk_0.a);
        ((fqv)object).setTexture(this.a.c("themeSimple3"));
        ((fqv)object).setWidth(4);
        ((fqv)object).setX(414);
        ((fqv)object).setY(122);
        fyg_02.addBasicElement((fyo)object);
        ((fyo)object).onAttributesInitialized();
        ((fyb_0)object).onChildrenAdded();
        fbm_22 = fqv.checkOut();
        fbm_22.setElementMap(fyy_03);
        ((fqv)fbm_22).setHeight(4);
        ((fqv)fbm_22).setPosition(frk_0.c);
        ((fqv)fbm_22).setTexture(this.a.c("themeSimple3"));
        ((fqv)fbm_22).setWidth(1);
        ((fqv)fbm_22).setX(419);
        ((fqv)fbm_22).setY(122);
        fyg_02.addBasicElement(fbm_22);
        fbm_22.onAttributesInitialized();
