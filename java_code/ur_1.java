...
public class ur_1
implements gs_0 {
    public final ArrayList<us_1> a = new ArrayList(0);
    ...
    public boolean a(ByteBuffer byteBuffer) {
        ...
        for (int k = 0; k < this.a.size(); ++k) {
            us_1 us_12 = this.a.get(k);
            boolean bl = us_12.a(byteBuffer);
            if (bl) continue;
            return false;
        }
        return true;
    ...
    public final void a(StringBuilder stringBuilder, String string) {
        ...
        if (this.a.isEmpty()) {
            ...
            for (int k = 0; k < this.a.size(); ++k) {
                us_1 us_12 = this.a.get(k);
                us_12.a(stringBuilder, string + k + "/ ");
            }
        }
    }
}
