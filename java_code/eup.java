...
extends esi_0 {
    ...
    public eup(ArrayList<aot_2> arrayList) {
    ...
    public long a(Object object, Object object2, Object object3, Object object4) {
        ...
        Integer n = optional.map(arg_0 -> erQ.f.apply(arg_0)).map(arg_0 -> erQ.a.apply(arg_0)).map(arg_0 -> erQ.b.apply(arg_0)).map(tIntObjectHashMap -> new euq_0(l).a((TIntObjectHashMap<aeo_2>)tIntObjectHashMap)).map(arg_0 -> erQ.e.apply(arg_0)).orElse(0);
