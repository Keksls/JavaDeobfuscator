...
implements fyq {
    ...
    public fyo a(fya_0 fya_02, fyy_0 fyy_02) {
        ...
        fso6.setPrefSize(new fjf_2(280, 56));
        fso6.setStyle("challengeZoneLeft");
        ...
        fqo_03.setInsets(new Insets(0, 28, 0, 22));
        ...
        fso8.setPrefSize(new fjf_2(75, 55));
        fso8.setStyle("challengeZoneCenter");
        ...
        fqo_04.setInsets(new Insets(1, 0, 0, 7));
        ...
        fso10.setPrefSize(new fjf_2(0, 23));
        ...
        fso11.setPrefSize(new fjf_2(0, 0));
        fso11.setStyle("shortcutRowBackgroundFull");
        ...
        fqm_05.setInsets(new Insets(2, 10, 3, 0));
        ...
        fsk_02.setStyle("challengeTimer");
        ...
        fso13.setPrefSize(new fjf_2(0, 23));
        ...
        fso15.setStyle("shortcutRowBackgroundFull");
        ...
        fsM4.setStyle("bold");
        String string4 = "%round%";
        string4 = string4.replace("%round%", fpm_0.b().c("round"));
        fsM4.c(string4);
        ...
        fiy_16.setField("roundNumber");
        fiy_16.setName("arcadeDungeon");
        ...
        String string5 = "arcadeDungeonDetails";
        fso fso17 = fso.checkOut();
        fso17.setElementMap(fyy_03);
        if (fyy_03 != null && string5 != null) {
            fyy_03.a(string5, fso17);
        }
        fso17.setPrefSize(new fjf_2(0, 0));
        fso17.setStyle("challengeCurrent");
        fso17.setVisible(false);
        fso5.addBasicElement(fso17);
        ...
        fqm_09.setInsets(new Insets(0, 29, 0, 0));
        ...
        fqo_05.setInsets(new Insets(15, 32, 28, 32));
        fqj10.addBasicElement(fqo_05);
        ...
        fiy_17.setField("challenges");
        fiy_17.setName("arcadeDungeon");
    ...
    public fyo b(fso fso2) {
        ...
        fus_02.setPrefSize(new fjf_2(300, 20));
        ...
        fir_18.setField("finished");
        fqh_04.addBasicElement(fir_18);
        fir_18.onAttributesInitialized();
        far_2 far_25 = new far_2();
        far_25.onCheckOut();
        far_25.setElementMap(fyy_02);
        far_25.setElseValue("0.3,0.3,0.3,0.3");
    ...
    public fyo a(fvk_0 fvk_02) {
        ...
        fsk_02.onCheckOut();
        fsk_02.setElementMap(fyy_02);
        fsk_02.setStyle("FakeArcadeDungeonCheckBox");
    ...
    public fyo b(fvk_0 fvk_02) {
        ...
        fdy_12.a("wakfu.arcadeDungeon:onArcadeDungeonCheckBoxOver(arcadeDungeonDetails)");
        fup_02.setOnMouseEnter(fdy_12);
        fdz_1 fdz_12 = new fdz_1();
        fdz_12.a("wakfu.arcadeDungeon:onArcadeDungeonCheckBoxOut(arcadeDungeonDetails)");
        fup_02.setOnMouseExit(fdz_12);
        fdi_2 fdi_22 = new fdi_2();
        fdi_22.a("wakfu.arcadeDungeon:openCloseArcadeDungeonSmallDialog(arcadeDungeonDetails)");
        fup_02.setOnSelectionChange(fdi_22);
        fup_02.setStyle("arcadeDungeon");
        fvk_02.addBasicElement(fup_02);
        fup_02.onAttributesInitialized();
        fiy_1 fiy_12 = fiy_1.checkOut();
        fiy_12.setElementMap(fyy_02);
        fiy_12.setAttribute("selected");
        fiy_12.setName("challengeDetailsVisible");
        ...
        fiy_13.setName("isInFightPlacement");
