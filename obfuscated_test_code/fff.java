...
public abstract class fff implements Comparable<fff> {
    ...
    public void acr(double ack) {
        if (ack < 0) {
            throw new IllegalArgumentException("acs");
        }
        this.ack = ack;
    }
    ...
    public void acu(int acv) {
        ...
        if (acw < 0) {
            throw new IllegalArgumentException("acx");
        }
        this.acl = acw;
    }
    ...
    public boolean equals(Object add) {
        ...
        fff adc = (fff) add;
        return Objects.equals(aci, adc.aci);
    }
    
    @Override
    public int hashCode() {
        return Objects.hash(aci);
    }
...
class aag extends fff {
    ...
    public String aee() {
        return "aef-" + uuu() + "-" + System.currentTimeMillis() % 10000;
    }
